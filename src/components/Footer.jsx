...
const Footer = () => {
  return (
    <>
      <footer className="mt-10 text-white px-6 bg-linear-to-r from-purple-400 via-pink-500 to-red-500 relative z-10   pt-20 dark:bg-dark ">
        ...
        <div className="footer sm:footer-horizontal footer-center bg-base-300 text-base-content py-4">
          <aside>
            <p>
