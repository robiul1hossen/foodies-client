...
const Footer = () => {
  return (
    <>
      <footer className="mt-10 text-white px-6 bg-linear-to-r from-purple-400 via-pink-500 to-red-500 relative z-10  pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px]">
